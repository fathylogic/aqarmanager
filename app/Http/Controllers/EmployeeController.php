...
class EmployeeController extends Controller
{
    ...
    {
        return 'this from EmployeeController' ;
    }
    ...
    public function index(Request $request): View
    {
        ...
        $data = Employee::with('maincenter', 'center', 'employeeType', 'employeeStatus')->get();
    ...
    public function get_centers($id)
    {
        ...
        $centers =   Center::where('maincenter_id', $id)
            ->orderby('id')
            ->get();
    ...
    public function create(): View
    {
        ...
        return view('employees.create', compact('current_user', 'maincenters', 'nationalities', 'centers', 'empTypes', 'empStatus'));
    }
    ...
    public function show($id, Request $request)
    {
        ...
        if ($request->has('btn_saveSalary')) {
            //  dd($request->all());  // sava sarf and update payroll
            ...
            if ($sarf =  Sarf::create($input)) {
                ...
                if ($sarf->pay_role_id != '') {
                    ...
                    return redirect()->route('employees.show', $id)
                        ->with('success', '     تم صرف الراتب  بنجاح');
                }
            }
        }
        ...
        if ($request->has('btn_add_vacation')) {
            ...
            $this->validate($request, [
                ...
                'start_date' => 'يجب اختيار تاريخ بداية الاجازة',
                'end_date' => 'يجب اختيار تاريخ نهاية الاجازة',
                'start_dateh' =>  'يجب اختيار تاريخ بداية الاجازة',
                'end_dateh' =>'يجب اختيار تاريخ نهاية الاجازة',
                'emp_id' => 'يجب اختيار الموظف '
            ]);
            ...
            if ($this->check_vac_dates($request->start_date, $request->end_date, $request->emp_id)) {
                if ($vaction =  Vacation::create($input)) {
                    ...
                    return redirect()->route('employees.show', $id)
                        ->with('success', '     تم   تسجيل الاجازة  بنجاح');
                }
            } else {
    ...
    public function edit($id): View
    {
        ...
        $centers = Center::get();
        $nationalities = Nationality::get();
        return view('employees.edit', compact('employee', 'current_user', 'nationalities', 'centers'));
    }
