...
">
        <strong>تنبيه</strong>
        <p id="alertMessage" style="margin:8px 0"></p>
        <a id="alertLink" href="#" class="btn btn-sm btn-warning">
            الاطلاع على الدفعات
        </a>
    </div>

    <div class="help-center-header_  rounded d-flex flex-column justify-content-center align-items-center bg-help-center pt-5 px-5">
    <h3 class="text-center">  </h3>
    <div class="input-wrapper input-group input-group-lg input-group-merge">
        <span class="input-group-text" id="basic-addon1"><i class="ti ti-search"></i></span>
        <input type="text" class="form-control" placeholder="بحث سريع" aria-label="بحث"
...
{{--                            <a class="home-page-linke" href="{{ route('units.add_unit') }}">--}}
{{--                                <div class="card-body text-center">--}}
{{--                                    <svg id="center-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                       width="58" height="58" viewBox="0 0 411 401">--}}
{{--                                        <defs>--}}
...
{{--                                    <h5 class="my-2"> اضافة بيانات الوحدات (الشقق) </h5>--}}
...
<!-- /Popular Articles -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            fetch("{{ route('login.alert') }}")
                .then(response => response.json())
                .then(data => {
                    if (data.show_alert) {
                        document.getElementById('alertMessage').innerText = data.message;
                        document.getElementById('alertLink').href = data.url;

                        let box = document.getElementById('loginNotification');
