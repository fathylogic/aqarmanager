...
{{--                                            <input type="text" class="gregorian-date" onblur="calculateDiff();"--}}
...
@section('js')
    ...
    <script>
        ...
        function generatePayments() {
            ...
            const total_amount = parseInt(document.getElementById('total_amount').value);
            ...
            const totalAmount = total_amount.toFixed(2);
...
<input type="hidden" lang="en" name="payment_for[]" class="form-control "
        ...
        `;
                ...
                for (let j = 1; j <= noOfPayments && countPayments <= no_of_all_payments ; j++) {
                    ...
                    let paymentValue = singlePaymentAmount ;
