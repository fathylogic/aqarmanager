...
@section('content')
    ...
    <form method="POST" action="{{ route('contracts.update',$contract->id) }}" id="contractForm" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" value="{{$contract->e_no}}" autocomplete="off"
                                           onkeypress="return onlyNumbers(event)"
                                           onkeyup="return numberValidation(event)" id="e_no" name="e_no"
                                           class="form-control"/>
                                </div>
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="maincenter_id" onchange="fn_get_centers(this.value )"
                                        ...
                                        @foreach ($maincenters as $row)
                                            <option  @if($row->id == $contract->maincenter_id) {{'selected'}}@endif value="{{ $row->id }}">{{ $row->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-4" id="center_div">
                                    ...
                                    <select id="center_id" name="center_id"
                                        ...
                                        @foreach ($centers as $row)
                                            <option  @if($row->id == $contract->center_id) {{'selected'}}@endif value="{{ $row->id }}">{{ $row->center_name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-4" id="unit_div">
                                    ...
                                    <select id="unit_id" name="unit_id"
                                        ...
                                        @foreach (@$units as $row)
                                            <option  @if($row->id == @$contract->unit_id) {{'selected'}}@endif value="{{ $row->id }}">
                                                {{@$row->unitType->name}}
                                                رقم
                                                {{$row->unit_no}}
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="period_year" id="period_year" onchange="calculateEndDate()"
                                                ...
                                                <?php for ($i = 1;
                                                           $i <= 10;
                                                           $i++): ?>
                                                <option value="<?= $i ?>" @if($contract->contractPeriod()['years']==$i){{'selected'}}@endif><?= $i ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="period_month" id="period_month" onchange="calculateEndDate()"
                                                ...
                                                <?php for ($i = 1;
                                                           $i <= 11;
                                                           $i++): ?>
                                                <option value="<?= $i ?>" @if($contract->contractPeriod()['months']==$i){{'selected'}}@endif><?= $i ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="period_day" id="period_day" onchange="calculateEndDate()"
                                                ...
                                                <?php for ($i = 1;
                                                           $i <= 30;
                                                           $i++): ?>
                                                <option value="<?= $i ?>" @if($contract->contractPeriod()['days']==$i){{'selected'}}@endif><?= $i ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label" for="total_amount"> اجمالي قيمة الايجار       <i
                                            class="fa fa-asterisk "
                                            style="color: red" aria-hidden="true"></i></label>
                                    <input type="text" autocomplete="off" onkeypress="return onlyNumbers(event)"
                                           onkeyup="return numberValidation(event)" onfocus="calculateDiff();"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type='text' onkeypress="return onlyNumbers(event)"
                                           ...
                                           name="start_payment_amount"   value="{{$contract->start_payment_amount}}"  class="form-control"/>
...
<hr>
                                <div class="card-header bg-lighter   bg-gradient  text-white">
                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 border rounded text-center fw-bold bg-dark float-start p-1 me-1 mb-1 h-100">
                                            مجموع مبالغ العقد كاملا شامل التامين والخدمات  :
                                            {{ $sumPayments['all'] }}
                                        ...
                                        <div class="col-md-5 border rounded text-center fw-bold bg-dark float-start p-1 me-1 mb-1 h-100">
                                            مجموع مبالغ الدفعات الايجارية :
                                            {{ $sumPayments['allYearPayment'] }}
                                        ...
                                        <div class="col-md-6 border rounded text-center fw-bold bg-dark float-start p-1 me-1 mb-1 h-100">
                                            مجموع مبالغ الدفعات الايجارية المدفوعة :
                                            {{ $sumPayments['allYearPaymentPayed'] }}
                                        ...
                                        <div class="col-md-5 border rounded text-center fw-bold bg-dark float-start p-1 me-1 mb-1 h-100">
                                            مجموع مبالغ الدفعات الايجارية المتبقية :
                                            {{ $sumPayments['allYearPaymentNotPayed'] }}
                                ...
                                <div id="payments_table_container" style="display:block;">
                                    ...
                                    @if (!empty($contract->payments))
                                        ...
                                        <table class="table table-striped  display responsive text-nowrap ">
                                            <thead>
                                        ...
                                        @foreach ($contract->payments as $key => $payment)
                                            ...
                                            <tr class="{{ $class }} contract{{$row->id}}"
                                                ...
                                                <td class="no-print">
                                                        ...
                                                        <a  href="javascript:void(0)"  onclick="fn_update_payement({{ $payment }})"  class="btn btn-sm btn-primary"><i
    ...
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"  id="updatePaymentModal" tabindex="-1" aria-labelledby="updatePaymentModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <form method="POST" action="" name="updatePaymenForm" id="updatePaymenForm" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header  bg-primary">
                        <h5 class="modal-title bg-lighter text-white" id="updatePaymentModalLabel"> تعديل تاريخ ومبلغ الدفعة   </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
...
@section('js')
    ...
    <script>
        ...
        const criticalFields = ['no_of_payments', 'year_amount', 'insurance_amount', 'services_amount', 'total_amount','start_payment_amount','no_of_all_payments'];
