            ...
            <table class="table table-striped  display responsive nowrap FathyTable ">
                <thead>
                    <tr>
                        ...
                        <th> الجوال </th>
                        <th> العنوان </th>
                        <th class="no-print"> صورة المستند </th>
                    ...
                    @foreach ($data as $key => $recipient)
                        <tr id="recipient{{$recipient->id}}">
                            ...
                            <td class="no-print">
                                ...
                                <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"  id="imgModal{{ $recipient->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img class="d-block" src="<?= asset('storage/' . $recipient->img) ?>"
                                                    width="100%">
                                            </div>
                            ...
                            <td class="no-print">
                                ...
                                <a href="{{ route('recipients.show', $recipient->id) }}" class="btn btn-sm btn-warning">
                                ...
                                <a href="javascript:void(0)"
                                   onclick="fn_delete_object({{ $recipient->id }}, 'recipient', 'recipient{{ $recipient->id }}')"
