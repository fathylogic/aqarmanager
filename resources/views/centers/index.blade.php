                    ...
                    @foreach ($data as $key => $center)
                        <tr>
                            ...
                            <td class="no-print">
                                ...
                                <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"   aria-hidden="true" id="exampleModal{{ $center->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="<?= asset('storage/' . $center->img) ?>" width="100%">
                                            </div>
                            ...
                            <td class="no-print">
                                ...
                                <a href="{{ route('centers.show', $center->id) }}" class="btn btn-sm btn-warning">
                                   <i class="fa-solid fa-circle-info pe-2"></i> فتح
                                </a>
                                <a href="{{ route('centers.edit', $center->id) }}" class="btn btn-sm btn-primary"><i
                                        class="fa-regular fa-pen-to-square pe-2"></i> تعديل</a>
                                <a href="#" onclick="fn_delete_center({{ $center->id }})"
                                    class="btn btn-sm btn-danger delete-record"><i class="fa-solid fa-trash-can pe-2"></i>
                                    حذف</a>
