                                                    ...
                                                    <div class="card border">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="form-label" for="no_of_rooms"> عدد
                                                                        الغرف
                                                                    </label>
                                                                    <input type="text" id="no_of_rooms"
                                                                           name="no_of_rooms"
                                                                           value="{{ $unit->no_of_rooms }}"
                                                                           class="form-control"/>
                                                                </div>
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select id="current_renter_id"
                                                                        ...
                                                                        @foreach ($renters as $row)
                                                                            <option value="{{ $row->id }}"
                                                                            @if ($unit->current_renter_id == $row->id)
                                                                                {{ 'selected' }}
                                                                                @endif>
                                                                                {{ $row->name }}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <textarea id="notes" name="notes"
                                                                              class="form-control">{{ $unit->notes }}</textarea>
                                                                </div>
...
{{--                                                     data-range-group="contract" data-validate="range">--}}
{{--                                                    <div class="field-row gregorian-row ">--}}
{{--                                                        <input type="text" class="gregorian-date"--}}
{{--                                                               onchange="calculateDiff();" name="start_date"--}}
{{--                                                               id="start_date"--}}
...
{{--                                            <div class="col-md-4">--}}
{{--                                                <label class="form-label" for="delay_fine"> غرامة التأخير في اليوم--}}
{{--                                                    الواحد--}}
