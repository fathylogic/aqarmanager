                    ...
                    @foreach ($data as $key => $unit)
                        <tr id="unit{{$unit->id}}">
                            ...
                            <td class="no-print">
                                ...
                                <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"  id="exampleModal{{ $unit->id }}" tabindex="-1"
                            ...
                            <td class="no-print">
                                <a href="{{ route('units.show', $unit->id) }}" class="btn btn-sm btn-warning">
                                    <i class="fa-solid fa-circle-info pe-2"></i> فتح
                                </a>
                                <a href="{{ route('units.edit', $unit->id) }}" class="btn btn-sm btn-primary"><i
